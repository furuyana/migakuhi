const morningTasks = ["白湯を飲む", "顔を洗う・保湿する", "鏡を見て笑顔チェック", "今日の自分を褒める"];
const nightTasks = ["メイクを丁寧に落とす", "フェイスマッサージをする", "肩を回して深呼吸", "明日の服を準備する"];
const specialTasks = [
...
function getTodayIndex() {
  ...
  if (!start) localStorage.setItem("startDate", startDate.toISOString());
